	...
	public LibFuncModifyUser() {
		...
		btnFindUser.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					// Runs the query and fills out text fields while keeping track of whether the
					// library card existed or not.
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (txtFieldLibCard.getText().contentEquals(libCard) && Validator.checkName(txtFieldFirst.getText())
						&& Validator.checkName(txtFieldLast.getText()) && Validator.checkEmail(txtFieldEmail.getText())
						&& Validator.checkPhone(txtFieldPhone.getText())) {
					try {
