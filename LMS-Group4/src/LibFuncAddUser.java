		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (Validator.checkName(firstNameText.getText()) && Validator.checkName(lastNameText.getText())
					...
					try {
						// verifies that the library card doesn't exist already. Notifies user if it
						// does and resets the library card number.
						...
						if (count > 0) {
							JOptionPane.showMessageDialog(null,
									"Registration failed, Library Card already exists. Please try again.");
