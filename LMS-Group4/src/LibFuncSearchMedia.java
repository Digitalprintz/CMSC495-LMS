	...
	public LibFuncSearchMedia() 
	{
		...
		searchMediaBtn.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				try
				{
					//Verifies that the searchText box is not empty and has a length greater then 1 (Makes sure they enter atleast 2 characters)
		...
		//Handles changing to the Modify Media panel, allowing a librarian to modify any media.
